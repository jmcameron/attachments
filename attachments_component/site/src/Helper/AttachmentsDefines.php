...
class AttachmentsDefines
{
     ...
     */
    public static $ATTACHMENTS_VERSION = '4.2.0';

    /** The Attachments extension version date
     */
    public static $ATTACHMENTS_VERSION_DATE = 'November  7, 2025';
     ...
     *     this easier to read.
     */
    public static $DEFAULT_ATTACHMENTS_ACL_PERMISSIONS =
    '{"attachments.delete.own":{"6":1,"3":1},
      "attachments.edit.state.own":{"6":1,"4":1},
      "attachments.edit.state.ownparent":{"6":1,"4":1},

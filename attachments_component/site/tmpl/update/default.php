...
<form class="attachments" <?php echo $enctype ?> name="upload_form"
	...
	<fieldset>
		<legend><?php echo Text::sprintf('ATTACH_UPDATE_ATTACHMENT_FOR_PARENT_S_COLON_S',
...
<?php if ( $this->may_publish ): ?>
		<div class="at_control"><label><?php echo Text::_('ATTACH_PUBLISHED'); ?></label><?php echo $this->lists['published']; ?></div>
<?php endif; ?>
...
<?php endif; ?>
		...
		<?php endif; ?>
		<p><?php echo Text::sprintf('ATTACH_LAST_MODIFIED_ON_D_BY_S',

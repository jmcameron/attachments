...
<?php else: ?>
  ...
  <tr>
   ...
   <tr>
	 ...
	 <td colspan="3"><?php echo $this->lists['url_valid']; ?></td>
   </tr>
   <?php endif; ?>
<?php endif; ?>
...
<?php endif; ?>
  ...
  <?php endif; ?>
  <tr><td class="key"><label for="icon_filename"><?php echo JText::_('ICON_FILENAME'); ?></label></td>
	  <td><?php echo $this->lists['icon_filenames']; ?></td>
	  <td class="key"><label><?php echo JText::_('FILE_TYPE'); ?></label></td>
...
?>
	<td class="key" title="<?php echo $tooltip; ?>"><label><?php echo JText::_('NUMBER_OF_DOWNLOADS'); ?></label></td>

...
<?php
   ...
   $this->startSection(SECT_NEW_V3);
      $this->startList();
         $this->addListElement('ATTACH_HELP_020100_TEXT', Array( '{SECT_PERMS}' => $this->sectionLink(SECT_PERMS) ));
         $this->addListElement('ATTACH_HELP_020200_TEXT', Array( '{SECT_ACCESS}' => $this->sectionLink(SECT_ACCESS) ));
   ...
   $this->startSection(SECT_FEAT);
      $this->startList();
		 $this->addListElement('ATTACH_HELP_030100_TEXT');
		 $this->addListElement('ATTACH_HELP_030200_TEXT');
		 ...
		 $this->addListElement('ATTACH_HELP_030600_TEXT');
            $this->startList();
               ...
               $this->addListElement('ATTACH_HELP_031100_TEXT', Array( '{SECT_FILES}' => $this->sectionLink(SECT_FILES) ));
            $this->endList();
      $this->endList();
   ...
   $this->startSection(SECT_SETNGS);
      ...
      $this->startSubSection(Array( 'id' => 'visibility-options',
         ...
         $this->startList();
             ...
             $this->addListElement('ATTACH_HELP_055700_TEXT', null, false);
                  $this->addFigure('options-hide-categories.png',
								   'ATTACH_HELP_055800_TEXT',
								   'ATTACH_HELP_055900_TEXT', 'figure width50');
             $this->endListElement();
             $this->addListElement('ATTACH_HELP_056000_TEXT');
         $this->endList();
...
// ??? $sstitle = JText::_('ATTACH_HELP_059000_SUBSECTION_TITLE');
   ...
   $this->addFigure(   'options-permissions.png',
					   ...
					   'ATTACH_HELP_060600_TEXT', 'figure width50');
...
// ??? $sstitle = JText::_('ATTACH_HELP_065000_SUBSECTION_TITLE');
   ...
   $this->startSection(SECT_ICONS);
      ...
      $this->startList('ol');
          ...
          $this->addListElement('ATTACH_HELP_120400_TEXT');
      $this->endList();
   ...
   $this->startSection(SECT_UNINST);
      $this->startList();
          $this->addListElement('ATTACH_HELP_160100_TEXT', null, false);
             $this->addPreBlock(JText::_('ATTACH_HELP_160200_TEXT'));
             $this->addParagraph('ATTACH_HELP_160300_TEXT');
          $this->endListElement();
          $this->addListElement('ATTACH_HELP_160400_TEXT',
          ...
          $this->addListElement('ATTACH_HELP_160500_TEXT');
      $this->endList();
